...
export type CustomerAmbassadorUpdateMutationVariables =
...
export type CustomerAmbassadorUpdateMutation = {
...
export type CustomerAmbassadorQueryVariables = CustomerAccountAPI.Exact<{
  language?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.LanguageCode>;
}>;

export type CustomerAmbassadorQuery = {
  customer: Pick<
    CustomerAccountAPI.Customer,
    'id' | 'displayName' | 'firstName' | 'lastName'
  > & {
    ambassador?: CustomerAccountAPI.Maybe<
      Pick<
        CustomerAccountAPI.Metafield,
        'id' | 'namespace' | 'key' | 'type' | 'value' | 'compareDigest'
      >
...
> & {
  ...
  favorites?: CustomerAccountAPI.Maybe<
    Pick<
      CustomerAccountAPI.Metafield,
      'id' | 'namespace' | 'key' | 'type' | 'value' | 'compareDigest'
    >
...
export type CustomerFavoritesUpdateMutationVariables =
  CustomerAccountAPI.Exact<{
    metafields:
      | Array<CustomerAccountAPI.MetafieldsSetInput>
      | CustomerAccountAPI.MetafieldsSetInput;
...
export type CustomerFavoritesUpdateMutation = {
  metafieldsSet?: CustomerAccountAPI.Maybe<{
    metafields?: CustomerAccountAPI.Maybe<
      Array<
        Pick<
...
export type CustomerFavoritesQueryVariables = CustomerAccountAPI.Exact<{
  language?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.LanguageCode>;
}>;

export type CustomerFavoritesQuery = {
...
interface GeneratedQueryTypes {
  '#graphql\n  query CustomerAmbassador($language: LanguageCode)\n  @inContext(language: $language) {\n    customer {\n      id\n      displayName\n      firstName\n      lastName\n\n      ambassador: metafield(\n        namespace: "custom"\n        key: "embaixador_alcimo"\n      ) {\n        id\n        namespace\n        key\n        type\n        value\n        compareDigest\n      }\n\n      orders(first: 100, reverse: true) {\n        nodes {\n          id\n          name\n          processedAt\n          financialStatus\n          fulfillmentStatus\n          totalPrice {\n            amount\n            currencyCode\n          }\n        }\n      }\n    }\n  }\n': {
    return: CustomerAmbassadorQuery;
    variables: CustomerAmbassadorQueryVariables;
  };
  ...
  '#graphql\n  query CustomerFavorites($language: LanguageCode)\n  @inContext(language: $language) {\n    customer {\n      id\n\n      favorites: metafield(\n        namespace: "custom"\n        key: "favoritos_alcimo"\n      ) {\n        id\n        namespace\n        key\n        type\n        value\n        compareDigest\n      }\n    }\n  }\n': {
    return: CustomerFavoritesQuery;
    variables: CustomerFavoritesQueryVariables;
  };
...
interface GeneratedMutationTypes {
  ...
  '#graphql\n  mutation CustomerAmbassadorUpdate(\n    $metafields: [MetafieldsSetInput!]!\n  ) {\n    metafieldsSet(metafields: $metafields) {\n      metafields {\n        id\n        namespace\n        key\n        type\n        value\n        compareDigest\n      }\n      userErrors {\n        field\n        message\n        code\n      }\n    }\n  }\n': {
    return: CustomerAmbassadorUpdateMutation;
    variables: CustomerAmbassadorUpdateMutationVariables;
  };
  '#graphql\n  mutation CustomerFavoritesUpdate(\n    $metafields: [MetafieldsSetInput!]!\n  ) {\n    metafieldsSet(metafields: $metafields) {\n      metafields {\n        id\n        namespace\n        key\n        type\n        value\n        compareDigest\n      }\n\n      userErrors {\n        field\n        message\n        code\n      }\n    }\n  }\n': {
    return: CustomerFavoritesUpdateMutation;
    variables: CustomerFavoritesUpdateMutationVariables;
  };
